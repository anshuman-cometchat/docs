...
description: "Integration Guide for Legacy Push Notifications — CometChat documentation."
---

<Warning>
**This integration is deprecated** and scheduled for removal. Migrate to the new Token-based Push Notifications.

See the [Push Notifications Guide](/notifications/push-overview) for the current implementation.
</Warning>
