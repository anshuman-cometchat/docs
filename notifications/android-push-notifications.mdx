...
<Info>
Make sure you complete [Push Notifications integration](/notifications/push-integration) steps before proceeding.
</Info>
...
1. Turn on the **Push Notifications**.
...
### 2.4 Push Notification Settings (dashboard)

- Navigate to **Push Notifications** > **Get Started / Integrate** in the CometChat dashboard.
