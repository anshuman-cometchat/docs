...
<Card
  ...
  icon="github"
  href="https://github.com/cometchat-team/uikit-ios/tree/master-v5/examples/push-notification-app"
>
...
| --- | --- | --- |
| `AppDelegate.swift` | Initializes CometChat, registers for APNs, sets `UNUserNotificationCenterDelegate`, hands off PushKit events to CallKit | Keep the init + delegate wiring; update bundle identifiers and capability flags. |
...
- [iOS push sample (GitHub)](https://github.com/cometchat-team/uikit-ios/tree/master-v5/examples/push-notification-app)
