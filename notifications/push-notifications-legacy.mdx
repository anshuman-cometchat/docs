...
description: "Consolidated legacy push notification setup guides."
---

# Push Notifications (Legacy)

<Callout>
All legacy push notification guides are consolidated here for easier reference. These flows are maintained for compatibility but are not receiving new features.
</Callout>
