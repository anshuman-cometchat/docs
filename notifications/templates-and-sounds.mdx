...
Use this guide to configure **push** notification templates (default vs privacy), understand placeholders, and set sounds. Email/SMS templates live in their own docs.
