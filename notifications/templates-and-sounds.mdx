...
@all mention templates are used when a text message contains an `@all` mention in a group conversation. All group members (who are not individually `@mentioned`) receive the notification using these templates.
