...
See [/notifications/email-custom-providers](/notifications/email-custom-providers) for webhook-based providers and payloads.

## Templates
See [/notifications/email-templates](/notifications/email-templates) for payload fields and subject examples when rendering your own emails.

## Preferences
See [/notifications/email-preferences](/notifications/email-preferences) for dashboard delivery limits and payload options.
