...
description: "Email Notifications (Legacy) — CometChat documentation."
---
...
1. Integration using [Webhook](#integration-using-webhook)
...
You can use our [Update user](/rest-api/chat-apis) API to set private metadata for a user. We recommend adding this code where you call our [Create user](/rest-api/chat-apis) API.
