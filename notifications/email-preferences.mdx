...
Configure how email notifications are sent and what goes into the payload.
...
Use these to balance payload size (stay under ~4 KB) and the data you need for rendering.
