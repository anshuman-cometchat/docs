...
See: `/notifications/sms-preferences`, `/notifications/sms-templates`, `/notifications/sms-custom-providers` for details and samples.
...
## Example flow
1) In CometChat dashboard, enable SMS Notifications and set preferences/throttling.
