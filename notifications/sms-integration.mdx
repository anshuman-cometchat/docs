...
## Custom SMS provider
See [/notifications/sms-custom-providers](/notifications/sms-custom-providers) for webhook-based providers and payloads.

## Templates
See [/notifications/sms-templates](/notifications/sms-templates) for payload fields to render your own SMS content.

## Preferences
See [/notifications/sms-preferences](/notifications/sms-preferences) for dashboard delivery limits and payload options.
