...
1. Create a Firebase project and add an Android app with your package name; download `google-services.json`.
2. Place `google-services.json` in `android/app`; apply `com.google.gms.google-services` in `android/app/build.gradle`.
