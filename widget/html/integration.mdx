...
| `width`, `height`, `isDocked` | <p>Adjust the widget width, height of widget.</p><p>**isDocked = true** - appears as icon on page and expands when clicked.</p> <p>**isDocked = false** - appears embedded on the page.</p> |
