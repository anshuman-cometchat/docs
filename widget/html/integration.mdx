...
| `width`, `height`, `isDocked` | Adjust the widget width, height of widget. isDocked = true - appears as icon on page and expands when clicked. isDocked = false - appears embedded on the page. |
