...
<Warning>
The Legacy Chat Widget is not customizable beyond the configuration options documented below. If you require deeper customization, consider using our [UI Kits](/ui-kit/react/overview) instead.
</Warning>
