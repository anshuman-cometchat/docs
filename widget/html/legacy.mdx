...
description: "HTML Widget (Legacy) — CometChat documentation."
---
...
Please open this document - [/rest-api/chat-apis) and refer to this Post API call ([/rest-api/chat-apis)) to create users and generate Auth token
