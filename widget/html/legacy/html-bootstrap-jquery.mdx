...
description: "Integrate the legacy CometChat Chat Widget into HTML, Bootstrap, or jQuery projects using the CometChatWidget JavaScript SDK with embedded or docked layouts."
---

<Info>
  **Quick Reference for AI Agents & Developers** - **What this page covers**:
  Integrating the legacy CometChat Chat Widget into HTML, Bootstrap, or jQuery
  projects using embedded and docked layouts - **Prerequisites**: A [CometChat
  Widget configured via the Dashboard](/widget/html/legacy/overview), your App
  ID, Region, Auth Key, and Widget ID - **Key action**: Copy-paste the HTML/JS
  code snippets to launch the Chat Widget in embedded or docked mode
</Info>

## Before getting started

Go through the [overview](/widget/html/legacy/overview) to set up Chat Widget from the CometChat Dashboard.
...
| --------- | ----------------------------------------------------------------------------------------------------- | -------- |
| FLAG      | Value could be _true_ or _false_ _true_ will open the chat window _false_ will close the chat window. | Required |
...
<CardGroup cols={2}>
  <Card title="Legacy Widget Overview" href="/widget/html/legacy/overview">
    Return to the legacy Chat Widget overview for setup instructions and
    dashboard configuration.
  </Card>
  <Card title="Widget Overview" href="/widget/html/overview">
    Explore the latest Chat Widget for HTML with modern integration options and
    features.
  </Card>
</CardGroup>
