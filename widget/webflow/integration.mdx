...
### Optional: auto-login with Memberstack (UID flow)

Use this if your Webflow site uses Memberstack. It logs in members automatically and falls back to a persistent guest ID.

**Head Code (Project Settings → Custom Code → Head):**
...
**Footer Code (Project Settings → Custom Code → Footer, or a page Embed):**
