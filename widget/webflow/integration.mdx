...
2) Select the website where you want to integrate CometChat.
3) Go to **Setting gear icon (Site Settings)** and open the **Custom Code** section.
4) (Optional) To avoid repeating the script in every Embed, add the CometChat script once in **Site Settings → Custom Code → Head Code**. 

For example: 
```<script defer src="https://cdn.jsdelivr.net/npm/@cometchat/chat-embed@1.x.x/dist/main.js"></script>```
If you prefer, you can also keep this script directly in the Embed snippet.

5) Click the **Save** button to apply the changes.
6) Publish your site.
7) Click Visit Website to view the integrated chat on your live site.
