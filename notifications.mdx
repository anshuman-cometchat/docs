...
<div className="mb-12">
    ...
    <ul className="list-disc ml-4 text-gray-600 dark:text-gray-300 mb-4">
      ...
      <li><a href="/notifications/templates-and-sounds">Attach metadata and custom payloads</a>.</li>
      <li><a href="/notifications/token-management">Manage tokens and device lifecycle</a>.</li>
      <li><a href="/notifications/preferences">Preferences</a> and <a href="/notifications/templates-and-sounds">templates & sounds</a> (<a href="/notifications/mute-functionality">mute</a>).</li>
    ...
    {/* <CardGroup cols={3}>
      <Card title="iOS (APNs)" href="/notifications/ios-apns-push-notifications" horizontal />
      <Card title="iOS (FCM)" href="/notifications/ios-fcm-push-notifications" horizontal />
      <Card title="Android" href="/notifications/android-push-notifications" horizontal />
      <Card title="React Native" href="/notifications/react-native-push-notifications" horizontal />
  ...
  <div className="mb-12">
    ...
    <ul className="list-disc ml-4 text-gray-600 dark:text-gray-300 mb-4">
      ...
      <li><a href="/notifications/preferences">User preferences and quiet hours</a>.</li>
  ...
  <div className="mb-12">
    ...
    <ul className="list-disc ml-4 text-gray-600 dark:text-gray-300 mb-4">
      ...
      <li><a href="/notifications/preferences">Preferences</a> and <a href="/notifications/templates-and-sounds">templates & sounds</a>.</li>
