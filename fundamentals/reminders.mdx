...
<CardGroup cols={2}>
  <Card title="Enable/Disable notifications" href="/rest-api/management-apis/extensions/reminders-enable-disable-notifications">
    Enable or disable push notifications for reminders.
  </Card>
