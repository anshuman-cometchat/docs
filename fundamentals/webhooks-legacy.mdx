...
description: "Webhooks (Legacy) — CometChat documentation."
---
...
For new projects, use **[Webhooks](/fundamentals/webhooks)**.
...
| --- | --- |
| Create a new webhook | [Create Webhook](/rest-api/chat-apis) |
| Update an existing webhook | [Update Webhook](/rest-api/chat-apis) |
| List all webhooks | [List Webhooks](/rest-api/chat-apis) |
| Get a webhook by ID | [Get Webhook](/rest-api/chat-apis) |
| Delete a webhook | [Delete Webhook](/rest-api/chat-apis) |

#### Trigger management endpoints

| Operation | API Reference |
| --- | --- |
| Add triggers to a webhook | [Add Triggers](/rest-api/chat-apis) |
| List all triggers of a webhook | [List Triggers](/rest-api/chat-apis) |
| Remove triggers from a webhook | [Remove Triggers](/rest-api/chat-apis) |
