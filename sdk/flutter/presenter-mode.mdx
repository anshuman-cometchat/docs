...
PresentationSettings viewerSettings = (PresentationSettingsBuilder()
  ..enableDefaultLayout = true
  ..isPresenter = false  // Viewer mode
  ..listener = this
).build();
```
</Info>
