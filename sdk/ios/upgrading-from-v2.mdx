...
Please follow the [setup](/sdk/ios/setup) instructions to upgrade to the latest V3 version.
...
You can read more about the `markAsDelivered()` method [here](/sdk/ios/delivery-read-receipts#mark-messages-as-delivered)
...
You can read more about the `markAsRead()` method [here](/sdk/ios/delivery-read-receipts#mark-messages-as-read).
