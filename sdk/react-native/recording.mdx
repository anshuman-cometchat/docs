...
The `onRecordingStarted` callback receives an event object with the user who started recording — see the [`OngoingCallListener`](/sdk/react-native/real-time-listeners#ongoing-call-listener-calls-sdk) reference for the full shape.
