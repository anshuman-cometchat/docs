...
<Steps>
  <Step title="Create a User">
    [Create a User](/rest-api/chat-apis) via the CometChat API when the user signs up in your app.
  </Step>
  <Step title="Create an Auth Token">
    [Create an Auth Token](/rest-api/chat-apis) via the CometChat API for the new user and save the token in your database.
  </Step>
