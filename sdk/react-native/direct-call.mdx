...
For the full list of callbacks, their descriptions, and parameter shapes, see the [`OngoingCallListener`](/sdk/react-native/real-time-listeners#ongoing-call-listener-calls-sdk) reference.
