...
<Tabs>
<Tab title="JavaScript (Delete User Conversation)">
```javascript
let UID = "UID";
let type = "user";
...
<Tab title="JavaScript (Delete Group Conversation)">
```javascript
let GUID = "GUID";
let type = "group";
...
<Tab title="Typescript (Delete User Conversation)">
```typescript
let UID: string = "UID";
...
<Tab title="Typescript (Delete Group Conversation)">
```typescript
