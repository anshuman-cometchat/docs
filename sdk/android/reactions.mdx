---
title: "Reactions"
description: "Add, remove, and manage emoji reactions on messages in your Android chat application"
---
...
```kotlin
// Add reaction
CometChat.addReaction(messageId, "😊", object : CallbackListener<BaseMessage>() {
    override fun onSuccess(message: BaseMessage) { }
    override fun onError(e: CometChatException) { }
})

// Remove reaction
CometChat.removeReaction(messageId, "😊", object : CallbackListener<BaseMessage>() {
    override fun onSuccess(message: BaseMessage) { }
    override fun onError(e: CometChatException) { }
})
...
val reactionRequest = ReactionRequest.ReactionRequestBuilder()
    ...
    .setLimit(30)
    .build()
reactionRequest.fetchNext(callback)

// Listen for real-time reaction events
CometChat.addMessageListener(listenerID, object : MessageReactionListener {
...
```java
// Add reaction
CometChat.addReaction(messageId, "😊", new CallbackListener<BaseMessage>() {
    @Override
...
// Remove reaction
CometChat.removeReaction(messageId, "😊", new CallbackListener<BaseMessage>() {
    @Override
    public void onSuccess(BaseMessage message) { }
    @Override
    public void onError(CometChatException e) { }
...
// Listen for real-time reaction events
CometChat.addMessageListener(listenerID, new MessageReactionListener() {
    @Override
...
<AccordionGroup>
  <Accordion title="Limit Reaction Types">
  ...
  <Accordion title="Handle Reaction Limits">
