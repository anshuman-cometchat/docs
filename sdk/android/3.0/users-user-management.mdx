...
2. You [log in the user to CometChat](/sdk/android/3.0/authentication) (programmatically)

## Creating a user

Ideally, user creation should take place at your backend. You can refer our Rest API to learn more about [creating a user](/rest-api/chat-apis) and use the appropriate code sample based on your backend language.
...
For more details on the fields present in the User class, please check [this](/sdk/android/3.0/users-user-management#user-class)
