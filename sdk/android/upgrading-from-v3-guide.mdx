...
Upgrading from v3.x to v4 is straightforward. Below are the major changes released as part of CometChat v4:

Follow the [setup](/sdk/android/setup) instructions to upgrade to the latest V4 version.
