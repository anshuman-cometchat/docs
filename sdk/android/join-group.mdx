...
*As a member of a group, how do I know if someone joins the group when my app is running?*
...
*As a member of a group, how do I know if someone joins the group when my app is not running?*

When you retrieve the list of previous messages, if a member has joined any group that the logged-in user is a member of, the list of messages will contain an `Action` message. An `Action` message is a sub-class of the `BaseMessage` class.
