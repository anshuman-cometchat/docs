...
description: "Managing Connections Manually — CometChat documentation."
---

<Warning>
**Deprecated:** The Ionic Cordova SDK is deprecated. For new Ionic/Cordova applications, please use the [JavaScript SDK](/sdk/javascript/managing-web-sockets-connections-manually) which provides full compatibility with Ionic applications.
</Warning>
