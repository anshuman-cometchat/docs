...
<Warning>
**Deprecated:** The Ionic Cordova SDK is deprecated. For new Ionic/Cordova applications, please use the [JavaScript SDK](/sdk/javascript/calling-overview) which provides full compatibility with Ionic applications.
</Warning>
...
2. Performed the steps mentioned in the [Setup](/sdk/ionic-legacy/setup#calling-component-configuration) guide
