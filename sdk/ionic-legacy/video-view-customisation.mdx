...
<Warning>
**Deprecated:** The Ionic Cordova SDK is deprecated. For new Ionic/Cordova applications, please use the [JavaScript SDK](/sdk/javascript/video-view-customisation) which provides full compatibility with Ionic applications.
</Warning>
...
Once you have decided to implement [Direct Calling](/sdk/ionic-legacy/direct-call) and followed the steps to implement them. Just few additional methods will help you quickly customize the main video container.

Please make sure your callSettings is configured accordingly for [Direct Calling](/sdk/ionic-legacy/direct-call).
