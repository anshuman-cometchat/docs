...
description: "Message — CometChat documentation."
---

<Warning>
**Deprecated:** The Ionic Cordova SDK is deprecated. For new Ionic/Cordova applications, please use the [JavaScript SDK](/sdk/javascript/message-structure-and-hierarchy) which provides full compatibility with Ionic applications.
</Warning>
...
<Frame>
  <img src="/images/c4abbbfb-iqfukf6oqo4xhfq9cc5n6oi2b34hkd8ybr6vijelf4nosa43ctmef9peiphswzma-84aaadb82c1a1591641305185fd89dcd.jpg" />
</Frame>
...
to know about Interactive messages please [click here](/sdk/ionic-legacy/interactive-messages)
