...
<Warning>
**Deprecated:** The Ionic Cordova SDK is deprecated. For new Ionic/Cordova applications, please use the [JavaScript SDK](/sdk/javascript/user-presence) which provides full compatibility with Ionic applications.
</Warning>
...
When you fetch the list of users, in the [User](/sdk/ionic-legacy/user-management#user-class) object, you will receive 2 fields
