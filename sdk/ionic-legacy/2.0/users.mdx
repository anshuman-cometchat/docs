...
You can begin with [user management](/sdk/ionic-legacy/2.0/users-user-management) to sync your users to CometChat. Once that is done, you can [retrieve users](/sdk/ionic-legacy/2.0/users-retrieve-users) and display them in your app.
