...
This guide demonstrates how to add chat to a Cordova/ionic application using CometChat. Before you begin, we strongly recommend you read the [Key Concepts](/sdk/ionic-legacy/2.0/key-concepts) guide.
...
The calling component requires some configuration. Please follow the steps mentioned [here](/sdk/ionic-legacy/2.0/overview#calling-component-configuration).
...
* [Presence Subscription](/sdk/ionic-legacy/2.0/user-presence)
