...
1. [User Listener](/sdk/ionic-legacy/2.0/resources-all-real-time-listeners#user-listener)
2. [Group Listener](/sdk/ionic-legacy/2.0/resources-all-real-time-listeners#group-listener)
3. [Message Listener](/sdk/ionic-legacy/2.0/resources-all-real-time-listeners#message-listener)
