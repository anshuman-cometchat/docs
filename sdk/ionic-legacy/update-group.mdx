...
<Warning>
**Deprecated:** The Ionic Cordova SDK is deprecated. For new Ionic/Cordova applications, please use the [JavaScript SDK](/sdk/javascript/update-group) which provides full compatibility with Ionic applications.
</Warning>
...
For more information on the `Group` class, please check [here](/sdk/ionic-legacy/create-group#group-class).
