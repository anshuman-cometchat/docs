...
description: "Presenter Mode — CometChat documentation."
---

<Warning>
**Deprecated:** The Ionic Cordova SDK is deprecated. For new Ionic/Cordova applications, please use the [JavaScript SDK](/sdk/javascript/presenter-mode) which provides full compatibility with Ionic applications.
</Warning>
