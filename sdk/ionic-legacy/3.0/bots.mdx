...
When you receive a message from CometChat, you can process it and provide a response using our [Send Bot Message](/rest-api/messages/send-bot-message) Rest API.
