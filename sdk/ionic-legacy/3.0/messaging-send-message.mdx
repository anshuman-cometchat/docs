...
1. A [text message](/sdk/ionic-legacy/3.0/messaging-send-message#text-message), the most common and standard message type.
2. A [media message](/sdk/ionic-legacy/3.0/messaging-send-message#media-message), for sending photos, videos and files.
3. A [custom message](/sdk/ionic-legacy/3.0/messaging-send-message#custom-message), for sending completely custom data using JSON structures.
