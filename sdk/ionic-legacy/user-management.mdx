...
<Warning>
**Deprecated:** The Ionic Cordova SDK is deprecated. For new Ionic/Cordova applications, please use the [JavaScript SDK](/sdk/javascript/user-management) which provides full compatibility with Ionic applications.
</Warning>
...
2. You [log in the user to CometChat](/sdk/ionic-legacy/authentication) (programmatically)

## Creating a user

Ideally, user creation should take place at your backend. You can refer to our Rest API to learn more about [creating a user](/rest-api/chat-apis) and use the appropriate code sample based on your backend language.
