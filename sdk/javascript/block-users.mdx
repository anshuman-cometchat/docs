...
It returns an object where each key is a `UID`, and the value contains the result of the block operation for that user:

- `success`: Indicates whether the block operation was successful (`true` or `false`)
- `message`: Provides a descriptive message for the result of the operation
...
It returns an object where each key is a `UID`, and the value contains the result of the unblock operation for that user:

- `success`: Indicates whether the unblock operation was successful (`true` or `false`)
- `message`: Provides a descriptive message for the result of the operation
