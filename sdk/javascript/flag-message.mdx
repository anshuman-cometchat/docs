---
title: "Flag Message"
description: "Learn how to flag inappropriate messages for moderation review using the CometChat JavaScript SDK."
---
...
<Note>
**Available via:** SDK | [REST API](https://api-explorer.cometchat.com) | Dashboard
</Note>
