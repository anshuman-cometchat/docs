...
On success, `sendMessage()` returns a [TextMessage](/sdk/reference/messages#textmessage) object.
...
<Note>
You can also send interactive messages with forms, cards, and buttons. See [Interactive Messages](/sdk/javascript/interactive-messages) for details.
</Note>
