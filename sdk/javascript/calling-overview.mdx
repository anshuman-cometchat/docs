...
- **Customizable UI** — Presenter mode, video view customization, and virtual backgrounds
...
<Card title="Get started with Ringing" icon="phone-volume" href="/sdk/javascript/default-call">
...
<Card title="Get started with Call Session" icon="video" href="/sdk/javascript/direct-call">
...
<Card title="Get started with Standalone Calling" icon="phone-flip" href="/sdk/javascript/standalone-calling">
...
<CardGroup cols={2}>
  <Card title="Calling SDK v4 (Stable)" icon="phone" href="/calls/v4/javascript/overview">
