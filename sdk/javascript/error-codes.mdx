...
description: "Complete reference for CometChat JavaScript SDK error codes, including client-side validation errors, server-side API errors, and how to handle them."
---
