...
<Note>
  Before you begin, ensure you have completed the [Calls SDK
  setup](/sdk/javascript/calling-setup).
</Note>
...
<Note>
  To understand user authentication in CometChat, see the [User
  Auth](/fundamentals/user-auth) documentation.
</Note>
...
<Note>
  For testing or POC purposes, you can create an auth token directly from the
  [CometChat Dashboard](https://app.cometchat.com). Navigate to **Users & Groups
  → Users**, select a user, and click **+ Create Auth Token**.
</Note>
...
| `setIdleTimeoutPeriod(number)`                            | Sets idle timeout in seconds. Warning appears 60 seconds before auto-termination. Default: `180` seconds. _v4.1.0+_                                      |
...
<Note>These methods can only be called when a call session is active.</Note>
...
<Tabs>
  <Tab title="TypeScript">```typescript CometChatCalls.switchCamera(); ```</Tab>
  <Tab title="JavaScript">```javascript CometChatCalls.switchCamera(); ```</Tab>
</Tabs>

<Note>
  This method is only supported on mobile browsers. It has no effect on desktop
  browsers. *Available since v4.2.0*
</Note>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript CometChatCalls.muteAudio(true); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript CometChatCalls.muteAudio(true); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript CometChatCalls.pauseVideo(true); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript CometChatCalls.pauseVideo(true); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript CometChatCalls.startScreenShare(); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript CometChatCalls.startScreenShare(); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript CometChatCalls.stopScreenShare(); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript CometChatCalls.stopScreenShare(); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript CometChatCalls.setMode(CometChat.CALL_MODE.SPOTLIGHT); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript CometChatCalls.setMode(CometChat.CALL_MODE.SPOTLIGHT); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript const audioInputDevices =
    CometChatCalls.getAudioInputDevices(); console.log("Available microphones:",
    audioInputDevices); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript const audioInputDevices =
    CometChatCalls.getAudioInputDevices(); console.log("Available microphones:",
    audioInputDevices); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript const audioOutputDevices =
    CometChatCalls.getAudioOutputDevices(); console.log("Available speakers:",
    audioOutputDevices); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript const audioOutputDevices =
    CometChatCalls.getAudioOutputDevices(); console.log("Available speakers:",
    audioOutputDevices); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript const videoInputDevices =
    CometChatCalls.getVideoInputDevices(); console.log("Available cameras:",
    videoInputDevices); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript const videoInputDevices =
    CometChatCalls.getVideoInputDevices(); console.log("Available cameras:",
    videoInputDevices); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript CometChatCalls.setAudioInputDevice(deviceId); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript CometChatCalls.setAudioInputDevice(deviceId); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript CometChatCalls.setAudioOutputDevice(deviceId); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript CometChatCalls.setAudioOutputDevice(deviceId); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">
    ```typescript CometChatCalls.setVideoInputDevice(deviceId); ```
  </Tab>
  <Tab title="JavaScript">
    ```javascript CometChatCalls.setVideoInputDevice(deviceId); ```
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="TypeScript">```typescript CometChatCalls.endSession(); ```</Tab>
  <Tab title="JavaScript">```javascript CometChatCalls.endSession(); ```</Tab>
</Tabs>
