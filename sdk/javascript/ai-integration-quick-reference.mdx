...
// AI Moderation - Check message status
...
**Prerequisites:** SDK initialized, user logged in, AI features enabled in [CometChat Dashboard](https://app.cometchat.com)
</Accordion>
