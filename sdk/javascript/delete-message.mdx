...
description: "Delete messages using the CometChat JavaScript SDK."
---
...
When fetching message history, deleted messages have `deletedAt` and `deletedBy` fields set. Additionally, an `Action` message is created when a message is deleted.
