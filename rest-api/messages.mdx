...
| [Send Threaded Message](/rest-api/messages/send-threaded-message)   | `POST`   | `/messages/{id}/replies`    | Reply to a message in a thread                   |
| [List Threaded Messages](/rest-api/messages/list-threaded-messages) | `GET`    | `/messages/{id}/replies`    | Retrieve all replies in a thread                 |
...
| [Remove Reaction](/rest-api/messages/remove-reaction)               | `DELETE` | `/messages/{id}/reactions`  | Remove an emoji reaction from a message          |
| [List All Reactions](/rest-api/messages/list-all-reactions)         | `GET`    | `/messages/{id}/reactions`  | List all reactions on a message                  |
| [Mark as Interacted](/rest-api/messages/mark-message-as-interacted) | `POST`   | `/messages/{id}/interacted` | Mark a message as interacted with                |
