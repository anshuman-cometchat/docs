...
1. **CometChat Account**: [Sign up](https://app.cometchat.com/signup) and create an app
2. **Credentials**: Note your **App ID**, **Region**, and **API Key** from the CometChat Dashboard
