...
description: "Ringing — CometChat documentation."
---
...
CometChat.initiateCall(call, 30, object : CometChat.CallbackListener<Call>() {
    override fun onSuccess(call: Call) {
        Log.d(TAG, "Call initiated: ${call.sessionId}")
        // Show outgoing call UI
    }
...
// Set a custom timeout of 30 seconds (default is 45 seconds)
CometChat.initiateCall(call, 30, new CometChat.CallbackListener<Call>() {
    @Override
    public void onSuccess(Call call) {
        Log.d(TAG, "Call initiated: " + call.getSessionId());
        // Show outgoing call UI
