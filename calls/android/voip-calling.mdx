...
description: "VoIP Calling — CometChat documentation."
---
...
To make an outgoing VoIP call, use the [CometChat Chat SDK](/sdk/android/calling-setup) to initiate the call, then join the session:
