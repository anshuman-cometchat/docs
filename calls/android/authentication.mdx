...
- CometChat Calls SDK must be [initialized](/calls/android/setup)
- Users must exist in your CometChat app (create via [Dashboard](https://app.cometchat.com) or [API](https://api-explorer.cometchat.com/reference/creates-user))
...
Once authenticated, you can start or join call sessions.

<Card title="Join Session" icon="phone" href="/calls/android/join-session">
  Generate a token and join a call session
</Card>
