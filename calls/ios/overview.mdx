...
description: "CometChat Calling SDK v5 - Beta Release - Calls SDK for iOS"
---

<Warning>
  This is a **beta release** of the Calls SDK v5. APIs and features may change before the stable release. For the current stable version, see the [Calls SDK v4 docs →](/calls/v4/ios/overview).
</Warning>
