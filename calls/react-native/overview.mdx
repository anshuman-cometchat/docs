...
If you're using CometChat UI Kits, voice and video calling is already integrated with ready-to-use components:
- Incoming & outgoing call screens
- Call buttons with one-tap calling
- Call logs with history

👉 [React Native UI Kit Call Features](/ui-kit/react-native/call-features)
