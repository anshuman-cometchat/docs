...
<div className="max-w-[70rem] mx-auto px-5"> 
  <Columns cols={2} className="items-center gap-x-12">
    <div className="flex flex-col justify-center h-full text-center md:text-left">
      ...
      <div className="inline-flex items-center bg-black text-white rounded-lg px-4 py-3 font-mono text-sm w-fit select-all cursor-text">
        <span className="text-gray-400 mr-2">$</span>
        <span>npx @cometchat/skills add</span>
      </div>
    </div>
...
<div className="mb-12">
  ...
  <Card
    title="Shopify"
    icon={<img src="/docs/images/icons/shopify.svg" alt="Shopify" />}
