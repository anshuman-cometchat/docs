...
You can also set this up from your end using the [Mark Blocked Message as Reviewed REST API](https://api-explorer.cometchat.com/reference/mark-moderation-blocked-message-reviewed).