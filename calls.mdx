...
<div className="mb-12">
  ...
  <CardGroup cols={4}>
    <Card title="JavaScript" icon={<img src="/images/icons/js.svg" alt="JavaScript" />} href="/calls/javascript/overview" horizontal />
    <Card title="React Native" icon={<img src="/images/icons/react.svg" alt="React Native" />} href="/calls/react-native/overview" horizontal />
    <Card title="iOS" icon={<img src="/images/icons/swift.svg" alt="iOS" />} href="/calls/ios/overview" horizontal />
    <Card title="Android" icon={<img src="/images/icons/android.svg" alt="Android" />} href="/calls/android/overview" horizontal />
    <Card title="Flutter" icon={<img src="/images/icons/flutter.svg" alt="Flutter" />} href="/calls/flutter/overview" horizontal />
    <Card title="Ionic" icon={<img src="/images/icons/ionic.svg" alt="Ionic" />} href="/calls/ionic/overview" horizontal />
  </CardGroup>
</div>
