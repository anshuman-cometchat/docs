...
<Tabs>
<Tab title="Kotlin">
```kotlin TabbedActivity.kt lines highlight={}
...
```xml res/menu/ic_chats.xml lines
...
```xml res/menu/ic_calls.xml lines
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    xmlns:tools="http://schemas.android.com/tools"
    android:width="32dp"
    android:height="32dp"
...
```xml res/menu/ic_user.xml lines
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    android:width="24dp"
    android:height="24dp"
    android:autoMirrored="true"
...
```xml res/menu/ic_group.xml lines
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    xmlns:tools="http://schemas.android.com/tools"
    android:width="24dp"
    android:height="24dp"
...
<Tabs>
<Tab title="Kotlin">
```kotlin MainActivity.kt lines highlight={15-17, 19}
import android.os.Bundle
...
<Tab title="Java">
```java MainActivity.java lines highlight={17-19, 21}
