...
```xml res/values/themes.xml lines
<resources>
    <style name="CustomMessageOptionSheetStyle" parent="CometChatPopupMenuStyle">
        <item name="cometchatPopupMenuItemStartIconTint">#F76808</item>
        <item name="cometchatPopupMenuBackgroundColor">#FFF9F5</item>
    </style>

    <style name="AppTheme" parent="CometChatTheme.DayNight">
        <item name="cometchatPopupMenuStyle">@style/CustomMessageOptionSheetStyle</item>
    </style>
</resources>
```
...
- **Code**:
```xml res/drawable/online_indicator_drawable.xml lines
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    android:width="18dp"
    android:height="18dp"
