...
Now that you've set up basic theming, explore more customization options:

- **[Color Resources](/ui-kit/android/color-resources)** - Complete list of color attributes
- **[Component Styling](/ui-kit/android/component-styling)** - Style individual components
- **[Message Bubble Styling](/ui-kit/android/message-bubble-styling)** - Customize message appearance
