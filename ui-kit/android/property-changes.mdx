---
title: "Property changes from V4 to V5"
description: "Reference of new, updated, and removed properties across all UI Kit components in the V4-to-V5 migration."
---
