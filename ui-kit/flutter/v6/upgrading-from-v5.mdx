...
5. ☐ Replace composite widgets (`CometChatMessages`, `CometChatConversationsWithMessages`) with individual widget composition
6. ☐ Test all features after migration

---

## Property Changes

This section outlines the property changes between V5 and V6. V6 introduces BLoC-based state management, removes composite widgets, and consolidates styling into `ThemeData` extensions.
...
| Composite Widgets | `CometChatMessages`, `CometChatConversationsWithMessages` | Removed — compose individually |
