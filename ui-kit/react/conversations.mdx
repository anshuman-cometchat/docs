...
<Note>
**Available via:** [UI Kits](/ui-kit/react/overview) | [SDK](/sdk/javascript/retrieve-conversations) | [REST API](https://api-explorer.cometchat.com)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Users" icon="users" href="/ui-kit/react/users">
    Browse and select users to start new conversations
  </Card>
  <Card title="Groups" icon="people-group" href="/ui-kit/react/groups">
