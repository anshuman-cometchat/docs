...
- **Login (dev):** `CometChatUIKit.login("UID")` | **Login (prod):** `CometChatUIKit.loginWithAuthToken("AUTH_TOKEN")`
- **Other methods:** `CometChatUIKit.logout()`, `CometChatUIKit.getLoggedinUser()`, `CometChatUIKit.createUser(user)`
