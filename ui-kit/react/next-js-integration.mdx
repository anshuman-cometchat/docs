...
<Card title="Build Conversation List + Message View" href="/ui-kit/react/next-conversation" icon="comments">
...
<Card title="Build One-to-One / Group Chat" href="/ui-kit/react/next-one-to-one-chat" icon="message">
  Step-by-step guide to build this layout
</Card>
...
<Card title="Build Tab-Based Chat" href="/ui-kit/react/next-tab-based-chat" icon="table-columns">
  Step-by-step guide to build this layout
</Card>
