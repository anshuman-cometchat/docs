...
description: "Step-by-step guide to integrate CometChat React UI Kit into your Next.js application with App Router support."
---
...
- **Framework:** Next.js (this page) | [React.js](/ui-kit/react/react-js-integration) | [React Router](/ui-kit/react/react-router-integration) | [Astro](/ui-kit/react/astro-integration)
...
<Frame>
  <iframe width="100%" height="400" src="https://www.youtube.com/embed/eNdTOVZUfhg" title="YouTube video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
</Frame>
...
| SSR hydration error | CometChat components use browser APIs on server | Wrap in `useEffect` or use dynamic import with `ssr: false`. See [Next.js Integration](/ui-kit/react/next-js-integration) |
...
<CardGroup cols={2}>
  <Card title="Conversation List + Message" href="/ui-kit/react/next-conversation">
    Two-panel layout with conversation list and message view.
  </Card>
  <Card title="One-to-One Chat" href="/ui-kit/react/next-one-to-one-chat">
    Focused direct messaging experience without a sidebar.
  </Card>
  <Card title="Tab-Based Chat" href="/ui-kit/react/next-tab-based-chat">
