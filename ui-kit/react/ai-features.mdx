...
description: "Overview of CometChat's AI-powered features including Conversation Starters, Smart Replies, and Conversation Summary — with the UI Kit components that power each feature."
---
...
- **Message List** → [CometChatMessageList](/ui-kit/react/message-list) (Conversation Starters)
...
**AI features covered:** Conversation Starters, Smart Replies, Conversation Summary
...
<Note>
**Before using AI features:** Ensure `CometChatUIKit.init(UIKitSettings)` has completed and the user is logged in via `CometChatUIKit.login("UID")`. AI features must also be activated from the [CometChat Dashboard](/fundamentals/ai-user-copilot/overview).
</Note>
...
| Conversation Starters not showing | Feature not enabled or no conversation context | Ensure [Conversation Starter](/fundamentals/ai-user-copilot/conversation-starter) is activated in Dashboard |
