...
description: "Display conversation history between users and AI assistants with CometChatAIAssistantChatHistory component in React Native UI Kit."
---
...
// Basic usage with user (must have @agentic role)
...
<CometChatAIAssistantChatHistory
  user={user}
  onMessageClicked={(message) => console.log("Selected:", message)}
  onNewChatButtonClick={() => console.log("New chat")}
...
- **AI Features** → [AI Features Overview](/ui-kit/react-native/ai-features)
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="AI Features" icon="robot" href="/ui-kit/react-native/ai-features">
