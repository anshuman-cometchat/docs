...
- **Getting Started** → [Integration Guide](/ui-kit/react-native/integration)
- **SDK Reference** → [CometChat SDK](/sdk/react-native/overview)
</Info>
...
<CardGroup cols={2}>
  <Card title="Integration" icon="plug" href="/ui-kit/react-native/integration">
