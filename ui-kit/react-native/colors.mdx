...
| `neutral300` | Incoming bubble background, borders | `#E8E8E8` | Incoming message bubbles |
| `neutral500` | Muted text, placeholders | `#A1A1A1` | Placeholder text, disabled states |
...
| `info` | Informational states | `#0B7BEA` | Info callouts |
