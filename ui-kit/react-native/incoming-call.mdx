...
<CometChatIncomingCall
  call={incomingCall}
  onDecline={(call) => console.log("Declined")}
/>

// With common props
<CometChatIncomingCall
  call={incomingCall}
  onAccept={(call) => console.log("Accepted:", call)}
  onDecline={(call) => console.log("Declined:", call)}
...
This action does not change the behavior of the component but rather listens for any errors that occur in the Incoming Call component.
