...
<CometChatGroupMembers
  ...
  onItemPress={(member: CometChat.GroupMember) => {
    console.log("Selected member:", member.getUid());
  }}
...
- **Add Members** → [CometChatAddMembers](/ui-kit/react-native/add-members)
- **Banned Members** → [CometChatBannedMembers](/ui-kit/react-native/banned-members)
</Info>
...
<Note>
**Available via:** [UI Kits](/ui-kit/react-native/overview) | [SDK](/sdk/react-native/retrieve-group-members) | [REST API](/rest-api/group-members/list)
</Note>
...
This action does not change the behavior of the component but rather listens for any errors that occur in the Group Members component.
...
return <CometChatGroupMembers group={group} onLoad={onLoadHandler} />;
```
...
return <CometChatGroupMembers group={group} onEmpty={onEmptyHandler} />;
```
...
| **searchPlaceholderText** | Used to set custom search placeholder text                                                           | `searchPlaceholderText?: string`                       |
...
| **usersStatusVisibility** | Toggle visibility of user status indicators                                                          | `usersStatusVisibility?: boolean`                      |
...
<CardGroup cols={2}>
  ...
  <Card title="Add Members" icon="user-plus" href="/ui-kit/react-native/add-members">
    Add new members to a group
  </Card>
  <Card title="Banned Members" icon="ban" href="/ui-kit/react-native/banned-members">
