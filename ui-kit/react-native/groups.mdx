...
| **selectionMode**         | This method determines the selection mode for groups, enabling users to select either a single group or multiple groups at once. | `selectionMode='multiple'` |
