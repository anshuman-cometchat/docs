...
To fit your app's design requirements, you can customize the appearance of the Message List component. We provide exposed methods that allow you to modify the experience and behavior according to your specific needs.
...
| **hideModerationStatus**       | Hides moderation status UI (bottom view) and suppresses moderation toasts                                                                          | `hideModerationStatus={true}`                             |
...
CometChatMessageTemplate is a pre-defined structure for creating message views that can be used as a starting point or blueprint for creating message views often known as message bubbles.
