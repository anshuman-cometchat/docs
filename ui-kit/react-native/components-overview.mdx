---
title: "Overview"
description: "Understand the architecture of CometChat React Native UI Kit components including Base Components, Components, Composite Components, Actions, Events, and Configurations."
---
...
```tsx
import { CometChatConversations, CometChatMessageList } from "@cometchat/chat-uikit-react-native";

// Base Components: Visual building blocks (no business logic)
// Components: Base + business logic (data loading, actions, events)
// Composite Components: Multiple components combined

// Example: Conversations is a Component
<CometChatConversations onItemPress={(conversation) => console.log(conversation)} />

// Example: MessageList is a Component
...
UI components based on their behavior and functionality can be categorized into three types: Base Components, Components, and Composite Components.
...
<CardGroup cols={2}>
  ...
  <Card title="Message List" icon="message" href="/ui-kit/react-native/message-list">
    Full chat interface with message list and composer
  </Card>
