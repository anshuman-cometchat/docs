...
| **usersStatusVisibility**              | Prop used to toggle user status visibility.                                                                                                           | `usersStatusVisibility={false}`              |
| **groupTypeVisibility**                | Prop used to toggle group type visibility.                                                                                                            | `groupTypeVisibility={false}`                |
| **deleteConversationOptionVisibility** | Prop used to toggle delete conversation option visibility.                                                                                            | `deleteConversationOptionVisibility={false}` |
