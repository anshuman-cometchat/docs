...
| Symptom | Cause | Fix |
| --- | --- | --- |
| CSS/theme not applied | Missing CSS import | Add `@import url("@cometchat/chat-uikit-angular/css-variables.css");` in your global styles |
...
Check both `showBackButton` and `hideBackButton` properties:

```typescript
// Back button visible
[showBackButton]="true" [hideBackButton]="false"

// Back button hidden (hideBackButton takes precedence)
[showBackButton]="true" [hideBackButton]="true"
```
...
| Resource | URL | Description |
|----------|-----|-------------|
| **Angular UIKit Repo** | [github.com/cometchat/cometchat-uikit-angular](https://github.com/cometchat/cometchat-uikit-angular) | Source code and issues |
