...
| `hideVoiceCallButton` | `boolean` | `false` | Hides the voice call button when `true`. Supports global config override. |
| `hideVideoCallButton` | `boolean` | `false` | Hides the video call button when `true`. Supports global config override. |
