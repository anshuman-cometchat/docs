...
| `hideBackButton` | `boolean` | `false` | Hide the back button (takes precedence over `showBackButton`) |
| `showBackButton` | `boolean` | `true` | Show the back button |
| `hideVoiceCallButton` | `boolean` | `false` | Hide the voice call button |
| `hideVideoCallButton` | `boolean` | `false` | Hide the video call button |
