...
- [CometChatAvatar](/ui-kit/angular/components/cometchat-avatar) - Used to display user avatars in receipt items
- [CometChatDate](/ui-kit/angular/components/cometchat-date) - Used to format receipt timestamps
