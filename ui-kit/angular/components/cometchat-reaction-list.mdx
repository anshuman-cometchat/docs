...
- [CometChatEmojiKeyboard](/ui-kit/angular/components/emoji-keyboard) - Emoji picker for adding reactions
- [CometChatPopover](/ui-kit/angular/components/cometchat-popover) - Popover component for displaying reaction list
