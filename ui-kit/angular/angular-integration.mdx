...
<Tab title="npm">
```bash
npm install @cometchat/chat-uikit-angular@5.0.0-beta1 @cometchat/chat-sdk-javascript
```
</Tab>
<Tab title="yarn">
```bash
yarn add @cometchat/chat-uikit-angular@5.0.0-beta1 @cometchat/chat-sdk-javascript
```
</Tab>
</Tabs>
...
<Tip>
  ...
  See the [State Management guide](/ui-kit/angular/guides/state-management) for details.
</Tip>
