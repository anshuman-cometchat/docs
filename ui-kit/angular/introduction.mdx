...
<Warning>
This is a beta release (`5.0.0-beta1`). APIs and components may change before the stable release. Report issues on [GitHub](https://github.com/cometchat/cometchat-uikit-angular/issues).
</Warning>
...
<CardGroup>
  <Card title="Angular Integration Guide" icon="rocket" href="/ui-kit/angular/angular-integration">
...
<CardGroup cols={2}>
  <Card title="Components" icon="grid-2" href="/ui-kit/angular/components/overview">
...
<CardGroup cols={3}>
  <Card title="Sample App" icon="github" href="https://github.com/cometchat/cometchat-uikit-angular">
    Working reference app
  </Card>
  <Card title="Source Code" icon="code" href="https://github.com/cometchat/cometchat-uikit-angular">
