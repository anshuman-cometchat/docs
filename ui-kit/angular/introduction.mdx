...
<Warning>
This is a beta release (`5.0.0-beta.1`). APIs and components may change before the stable release. Report issues on [GitHub](https://github.com/cometchat/cometchat-uikit-angular/issues).
</Warning>
...
<CardGroup>
  <Card title="Angular Integration Guide" icon="rocket" href="/ui-kit/angular/integration">
