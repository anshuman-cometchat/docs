...
| `hideVoiceCallButton` | `boolean` | `undefined` | Hide voice call button across components |
| `hideVideoCallButton` | `boolean` | `undefined` | Hide video call button across components |
...
| Component | Behavior |
|-----------|----------|
| [CometChatOngoingCall](/ui-kit/angular/components/cometchat-ongoing-call) | Accepts `callSettingsBuilder` as `@Input`. Passes it to `OngoingCallService`. |
