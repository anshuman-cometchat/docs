...
`CometChatUrlsFormatter` extends [CometChatTextFormatter](/ui-kit/angular/v5/guides/custom-text-formatter) to detect URLs in text messages and render them as clickable links.
