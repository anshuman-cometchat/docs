---
title: Overview
description: "CometChat Angular UIKit v5 — Pre-built UI components for adding chat to Angular applications"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Migration Guide" icon="arrow-up" href="/ui-kit/angular/v5/customization/migration-guide">
