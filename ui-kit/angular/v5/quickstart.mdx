...
<CardGroup cols={2}>
  <Card title="Integration Guide" icon="download" href="/ui-kit/angular/v5/integration">
    Full setup guide with examples
  </Card>
  <Card title="Components" icon="layer-group" href="/ui-kit/angular/v5/components/overview">
