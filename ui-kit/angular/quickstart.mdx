...
```bash
npm install @cometchat/chat-uikit-angular@5.0.0-beta1
```
...
<CardGroup cols={2}>
  <Card title="Integration Guide" icon="download" href="/ui-kit/angular/angular-integration">
    Full setup guide with examples
  </Card>
  <Card title="Components" icon="layer-group" href="/ui-kit/angular/components/overview">
