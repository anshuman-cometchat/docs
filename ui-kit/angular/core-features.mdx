...
| [cometchat-flag-message-dialog](/ui-kit/angular/components/cometchat-flag-message-dialog) | Displays the report dialog where users can select a reason and provide additional remarks. |
