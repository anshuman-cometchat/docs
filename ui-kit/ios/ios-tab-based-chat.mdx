...
```swift title="SceneDelegate.swift" highlight={5-7} lines
...
Create a new file `MessagesVC.swift`. This view controller assembles the header, message list, and composer.
