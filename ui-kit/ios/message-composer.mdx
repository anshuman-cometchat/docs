...
```json
{
  ...
  "compositionExample": {
    ...
    "flow": "User types message → onTextChangedListener fires → User taps send → onSendButtonClick fires → Message sent"
  },
  "types": {
...
class ChatViewController: UIViewController {
    ...
    private func setupMessageComposer(for user: User) {
        ...
        messageComposer.set(onTextChangedListener: { [weak self] text in
...
| `set(onTextChangedListener:)` | Triggered when text changes | Typing indicators |
...
messageComposer.hideImageAttachmentOption = true
messageComposer.hideVideoAttachmentOption = true
messageComposer.hideAudioAttachmentOption = true
messageComposer.hideFileAttachmentOption = true
```

### Hide all auxiliary buttons

```swift
let messageComposer = CometChatMessageComposer()
messageComposer.set(user: user)
messageComposer.hideAttachmentButton = true
...
let messageComposer = CometChatMessageComposer()
messageComposer.set(user: user)
messageComposer.disableMentions = true
```
...
let messageComposer = CometChatMessageComposer()
messageComposer.set(user: user)
messageComposer.disableSoundForMessages = true
```
