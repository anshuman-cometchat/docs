...
The `CometChatSettings` object controls everything the React Router Builder renders—messaging, AI helpers, calls, layout and theming.
...
<CardGroup cols={2}>
  ...
  >
    Learn how to customize components and extend functionality.
  </Card>
  <Card
    title="Directory Structure"
    href="/chat-builder/react-router/builder-dir-structure"
  >
    Understand the project organization for navigation and customization.
  </Card>
  <Card title="Integration Guide" href="/chat-builder/react-router/integration">
    Review the setup process and configuration options.
  </Card>
