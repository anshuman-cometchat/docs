...
description: "Overview of the CometChat UI Kit Builder directory layout for React Router — understand where to find and customize components, settings, and styles."
---
