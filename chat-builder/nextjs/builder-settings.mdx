...
The `CometChatSettings` object controls everything the Next.js Builder renders—messaging, AI helpers, calls, layout and theming.
...
<CardGroup cols={2}>
  ...
  <Card title="Integration Guide" href="/chat-builder/nextjs/integration">
    Step-by-step instructions for integrating the CometChat UI Kit Builder into
    your Next.js project.
  </Card>
  <Card title="Advanced Theming" href="/ui-kit/react/theme">
    Explore advanced theming options to fully customize the look and feel of
    your chat UI.
  </Card>
</CardGroup>
