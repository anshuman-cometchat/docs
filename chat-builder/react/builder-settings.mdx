...
The `CometChatSettings` object controls everything the React Builder renders—messaging, AI helpers, calls, layout, theming, no‑code widget options, and agent tools. Use this page as a definitive map of every toggle with recommended defaults.
