...
This guide outlines the infrastructure, software, and network requirements for deploying CometChat On-Prem. Proper capacity planning ensures optimal performance, cost efficiency, and scalability as your user base grows.
...
CometChat On-Prem is tested and supported on enterprise Linux distributions with long-term support (LTS) and security updates:
