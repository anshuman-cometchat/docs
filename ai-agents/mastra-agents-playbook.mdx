...
<CardGroup>
	<Card title="Frontend Actions Guide" href="/ai-agents/mastra-frontend-actions-agent" icon="/images/icons/ai-agents.svg">Emit safe UI actions from the agent.</Card>
</CardGroup>
...
<CardGroup>
	<Card title="Backend Tools Guide" href="/ai-agents/mastra-backend-tools-agent" icon="/images/icons/mastra.svg">Wire backend tools & external APIs.</Card>
</CardGroup>
