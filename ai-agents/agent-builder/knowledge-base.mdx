...
<Steps className="mt-6">
  ...
  <Step title="Choose the ingestion method" description="Match your content to the right tab.">
    Select from <strong>Files</strong>, <strong>Text</strong>, <strong>Links</strong> (coming soon), or <strong>Integrate</strong> (coming soon). The drawer updates its fields based on your selection.
  </Step>
