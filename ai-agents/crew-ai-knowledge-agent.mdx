...
Based on the refreshed [`ai-agent-crew-ai-examples`](https://github.com/) codebase, here’s how to run the `knowledge_agent` FastAPI service, ingest docs, and stream answers into CometChat.
...
- Dashboard → AI Agents → **Provider: CrewAI** → **Agent ID** (e.g., `knowledge`) → **Deployment URL** = your public `/stream`.
